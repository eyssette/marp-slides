...
2) Gérer les informations importantes
	* Utiliser un logiciel de listes pour avoir facilement à disposition certaines informations importantes [:link:](https://standardnotes.com/) [:link:](https://keep.google.com/u/0/#home)
3) Mémoriser les noms des élèves
...
1. Trouver des ressources numériques
	* Utiliser les ressources de la bibliothèque Diderot [:link:](https://www.bibliotheque-diderot.fr/catalogues/documentation-electronique)
...
<!-- Nouvel outil du Fediverse pour la collecte de liens : à voir -->
...
1) Utiliser les réseaux sociaux
	...
	* Sur Mastodon : liste de comptes philo [:link:](https://eyssette.github.io/Mastodon-Philosophy/), et d'autres disciplines [:link:](https://github.com/nathanlesage/academics-on-mastodon), hashtags et groupes [:link:](https://a.gup.pe/)
2) Utiliser des outils collaboratifs
...
2) Usages ordinaires
	...
	* Utiliser un logiciel en ligne [:link:](https://www.google.fr/intl/fr/slides/about/) [:link:](https://www.canva.com/)
