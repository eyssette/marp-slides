...
---
<!-- _class: souspartie -->
## A. Comment présenter<br> ces démarches ? <!-- fit -->
...
Présentation des démarches “conceptualiser” et “argumenter” dans un cours d'introduction à la philosophie : [un exemple](https://eyssette.github.io/marp-slides/slides/2022-2023/introduction-philosophie-22.html#1)


---
<!-- _class: i1t0 -->

![Schéma récapitulatif des 4 démarches](https://raw.githubusercontent.com/eyssette/graphviz-examples/master/diagram/introduction-philosophie-21.dot.svg)
...
![](https://lh4.googleusercontent.com/1ulGcPrv7WyRS1AL7nmS9mz7s1qR3_Y7bSKr6G8idWoaebdOGXWs7XpEHzBWo-j10q3ukIm5lMey37RzuvRnBpA791_JWj2XzUnpduhWoYIkLlhxsMMBF4_QF4kotl_-ZRsTYUmDKXgAGJin8RXqMtfy=s2048)


---
<!-- _class: souspartie -->
## B. Quels sont <br>les obstacles<br> pédagogiques ? <!-- fit -->
...
<span data-marpit-fragment="1">Il est difficile de savoir à l'avance quels sont les concepts et arguments qui vont bien fonctionner avec les élèves.</span>

* Quels sont les concepts et arguments qui ont bien fonctionné cette année avec les élèves ?


---
<!-- _class: f -->
<style scoped>
table {font-size:0.7em; margin-top:1em}
table span {font-size:0.8em;}
</style>

* Quels sont les concepts et arguments qui ont bien fonctionné cette année avec vos élèves ?

|Nom du <br>concept ou de l'argument|Cours dans lequel vous l'avez utilisé <br><span>(notions du programme)</span>|Manière dont vous l'avez utilisé|Qu'est-ce qui a bien marché ?|
|:-:|:-:|:-:|:-:|
|…|…|…|…|
|…|…|…|…|
|…|…|…|…|
...
<!-- Bien fonctionner : ils ont été intéressés, ils ont bien compris le contenu et ils arrivent à s'en emparer, à les réutiliser dans leurs copies

Moment de partage :
Le nom du concept ou de l'argument
Le cours dans lequel vous l'avez utilisé
La manière dont vous avez l'utilisé
-->
...
---
<!-- _class: partie -->
# II ‑ Comment <br>conceptualiser <br>et argumenter ? <!-- fit -->
Deuxième partie
