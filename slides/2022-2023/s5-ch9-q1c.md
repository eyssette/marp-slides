...
---
<!-- _class:  -->
1) Notre parole est un **marqueur social** : par la parole s'exprime notre position sociale. L'usage que nous faisons du langage est avant tout l'expression d'un rapport social.
2) Le vocabulaire que nous employons n’est **pas neutre**. Il exprime des valeurs et une interprétation particulière de la réalité.
