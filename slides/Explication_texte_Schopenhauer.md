...
### Point méthode
Il faut formuler le plan du texte, par soi-même : on explique ce que fait l'auteur.
On donne un titre à chaque partie.
On distingue 2 à 4 étapes dans chaque partie. Il s'agit soit d'étapes chronologiques distinctes dans le texte, soit d'étapes logiques entremêlées dans le texte.
