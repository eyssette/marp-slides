...
p:nth-of-type(2) {left:0px; bottom:25px}
p:nth-of-type(3) {left:500px; bottom:25px}
</style>

![bg](https://upload.wikimedia.org/wikipedia/commons/d/d1/JohnLocke.png)
![bg](https://upload.wikimedia.org/wikipedia/commons/e/ea/Spinoza.jpg)

:red_circle:

L'argument de <br>l'action volontaire
