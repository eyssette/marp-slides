...
<!-- _class: titre -->
# Q4 – <br>Quel est notre<br> devoir moral ? <!-- fit -->
...
p:nth-of-type(2), p:nth-of-type(3) {color:white; bottom:50px; font-size:1.2em; background-color:black; text-align:center; padding: 10px 30px}
p:nth-of-type(2) {left:20px; bottom:25px}
p:nth-of-type(3) {left:510px; bottom:25px}
</style>

![bg](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Jean-Jacques_Rousseau_%28painted_portrait%29.jpg/800px-Jean-Jacques_Rousseau_%28painted_portrait%29.jpg)
![bg](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Kant_gemaelde_3.jpg/800px-Kant_gemaelde_3.jpg)
...
<!--
Textes : https://docs.google.com/document/d/1KtSUEPHUTLNEf3idLJawfO9cisQMYtGUvpjhD-LyB18/edit?usp=sharing
 -->

---
<!-- _class: partie -->
# I – Les morales <br>du sentiment <!-- fit -->
Première partie

---
<!-- _class: definition -->
### Définition
Les **morales du sentiment** affirment que notre devoir moral est de faire preuve d'**empathie** et d'être **attentif aux autres**.
...
<!-- _class: definition -->
### Définition
Les **morales de la raison** affirment que pour déterminer notre devoir moral, il faut réfléchir : soit avant tout aux **conséquences** de nos choix, soit avant tout aux **principes** de nos choix.
...
<!-- = un exemple de morale des conséquences
