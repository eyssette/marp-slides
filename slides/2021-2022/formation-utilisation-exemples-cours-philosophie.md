...
<!-- _class: titre -->
<style scoped>
h1 {padding:10px; font-size:3.3em}
</style>
...
# I – Pour favoriser la<br> mobilisation des<br> connaissances <!-- fit -->
Premier usage
...
<!-- _class: sanspuces -->
<style>
section.sanspuces ol, section.sanspuces ul {list-style-type:none; margin-left:-10px}
</style>
<style scoped>
...
1) _Principe :_ combiner un support **verbal** (texte écrit ou oral) avec un support **visuel** (image ou vidéo)
2) _Finalité :_ améliorer le traitement de l'information et favoriser la récupération en mémoire.
2) _Plus d'information :_ le blog pédagogique [Par temps clair](https://par-temps-clair.blogspot.com/search/?q=double+codage)

<!-- La combinaison d’une information textuelle avec une information visuelle améliore l’apprentissage parce que nous traitons l’information verbale et l’information visuelle à travers des canaux différents. Avoir la même information mémorisée sous deux formats différents, verbal et imagé, donne deux façons de nous rappeler de l’information plus tard.
...
---
<!-- _class: souspartie -->
## A. Problématiser à partir <br>d'une situation qui<br> engage la discussion <!-- fit -->
...
---
<!-- _class: souspartie -->
## B. Problématiser à <br>partir d'une expérience<br> de pensée <!-- fit -->
...
---
<!-- _class: souspartie -->
## C. Problématiser à partir d'une liste de cas à discuter
...
---
<!-- _class: souspartie -->
## A. Construire une distinction conceptuelle
...
---
<!-- _class: souspartie -->
## B. Mieux comprendre <br>une notion <!-- fit -->
...
---
<!-- _class: souspartie -->
## C. Partir d'une série de cas

---
<!-- _class: i1t0 -->
![](https://i.ibb.co/dJmrhLh/banane-t.jpg)
...
# IV – Dans le <br>cadre d'une<br> argumentation <!-- fit -->
Quatrième usage


---
<!-- _class: souspartie -->
## A. Pour mieux <br>faire comprendre<br> une thèse <!-- fit -->
...
---
<!-- _class: souspartie -->
## B. Pour dégager le sens<br> concrets d'une idée <!-- fit -->
