...
<!-- _class: titre -->
# Q4 – Le bonheur <br>est-il le bien<br> suprême ? <!-- fit -->
...
<style scoped>
	ol {font-weight:bold}
ol ul {margin-left:-1.3em; font-weight:normal}
...
<style scoped>
ol {font-weight:bold}
ol ul {margin-left:-1.6em; font-weight:normal}
...
<!-- On retrouve les caractéristiques de la troisième vague du féminisme :
- extension de la critique du sexisme et des normes de genre (ici : tone-policing ; cf. figure de la féministe "rabat-joie")
...
1) La vie bonne ne se définit donc pas par l'absence de souffrances.

<!-- 
Ajouter éventuellement l'exemple de l'amour.
Comparer avec :
